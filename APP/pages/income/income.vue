	...
	<view>
		...
		<view class="box">
			<view class="show disc">
				...
				<view class="title">共计项目收益金额</view>
			</view>
			...
			<view class="" style="margin-top: 10upx;">
				<uni-table ref="table" border stripe emptyText="暂无更多数据" >
					...
					<uni-tr>
						...
						<uni-th align="center">收益金额</uni-th>
					</uni-tr>
					<!-- 表格数据行 -->
					<uni-tr v-for="(item,index) in tableData" :key="index">
						<uni-td align="center">{{item.send_time}}</uni-td>
						<uni-td align="center">{{item.send_money}}</uni-td>
					</uni-tr>
				</uni-table>
      ...
      dateText(newVal,oldVal) {
		...
		methods: {
			...
			getData(page,time) {
			  ...
			  const that = this
			  this.$fn.request('/log/income',"GET",params).then(res=>{
