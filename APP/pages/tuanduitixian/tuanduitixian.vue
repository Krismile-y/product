  ...
  <view class="withdrawal">
	     ...
	     <view>
	      ...
	      <view class="content-box">
	        ...
	        <!-- <view class="uni-list">
	          ...
	          <radio-group @change="radioChange">
	            <label class="uni-list-cell uni-list-cell-pd label-item" v-for="(item, index) in itemsChange"
	              :key="item.value">
	              <view>{{item.name+`(${index==0?info.money_hire:info.money_team})`}}</view>
	              <view>
	                <radio :value="item.value" :checked="index === currentMoney" />
	              </view>
	            </label>
	          </radio-group>
	        </view> -->
	      ...
	      <view class="bottom-fixd">
	        <view class="bot-btn" @tap="tuanduitixian">
	          提交申请
	        </view>
	      </view>
  ...
  export default {
    ...
    methods: {
      ...
      radioChange: function(evt) {
        console.log(evt,'单选点击');
        this.moneyType = evt.detail.value
      },
      // 打开银行卡列表
      open() {
        this.show = true
